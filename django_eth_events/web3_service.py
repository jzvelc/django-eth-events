...
class Web3Service(object):
    ...
    def __new__(cls, provider=None):
        ...
        elif provider and not isinstance(provider, Web3Service.instance.web3.providers[0].__class__):
            Web3Service.instance = Web3Service.__Web3Service(provider)
        elif not provider and not isinstance(Web3Service.instance.web3.providers[0], Web3Service.instance.default_provider):
            Web3Service.instance = Web3Service.__Web3Service(provider)
